...
import { FALLBACK } from '@/components/utils/slug';
import { getFormattedDate, sanitize } from '@/components/utils/miscellaneous';
import { HEADER_FOOTER_ENDPOINT } from '@/constants/endpoints';
import { getPost, getPosts, getComments } from '@/components/utils/blog';
		...
		<Layout headerFooter={ headerFooter || {} } seo={ postData?.yoast_head_json ?? {} }>
			<div className="post-wrapper">
					<Image
						...
						height="400"
						layout="fill"
						containerClassNames="post-image"
				...
				<div className='post-content' dangerouslySetInnerHTML={ { __html: sanitize( postData?.content?.rendered ?? '' ) } }/>
